      ...
      >
        ...
        >
          <template slot-scope="scope">
            ...
            <el-button style="margin-left: 10px;cursor: pointer;" type="warning" icon="el-icon-close" v-if="scope.row.status === 2" size="small" @click="CancelTheCeiling(scope.row)">{{ $t('message.CancelTheCeiling') }}</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
